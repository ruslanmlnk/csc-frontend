...
const SettingsPage: React.FC = () => {
    ...
    return (
        <div className="relative min-h-screen bg-[#0D0D0D] overflow-hidden selection:bg-[#F29F04] selection:text-black">
            {/* Background Glow */}
            <div className="absolute inset-x-0 top-0 z-0 w-full h-[1200px] pointer-events-none select-none overflow-hidden">
                ...
                <div className="absolute inset-0 z-[-1] w-full h-full" style={{ background: "linear-gradient(83deg, rgba(242, 159, 4, 0.70) 0.75%, #0D0D0D 30.5%, #0D0D0D 69.72%, rgba(242, 159, 4, 0.70) 99.19%)", backgroundBlendMode: "soft-light, normal" }} />
            ...
            <main className="relative z-10 w-full max-w-[1280px] px-5 pb-[120px] pt-[80px] md:pt-[120px] flex flex-col items-center gap-16 mx-auto">
                ...
                <div className="flex flex-col gap-16 w-full">
                    {/* Profile Photo */}
                    <div className="flex flex-col p-8 md:p-10 gap-10 rounded-[40px] border border-[rgba(74,74,74,0.70)] bg-[#1A1A1A] overflow-hidden">
                    ...
                    <div className="flex flex-col p-8 md:p-10 gap-10 rounded-[40px] border border-[rgba(74,74,74,0.70)] bg-[#1A1A1A]">

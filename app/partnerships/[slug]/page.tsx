  ...
  return (
    <div className="flex flex-col w-full min-h-screen bg-[#0D0D0D] text-white font-sans animate-fade-in-up">
      <main className="flex-1 w-full max-w-[1440px] mx-auto px-5 py-8 md:px-24 md:py-12">
        ...
        <Link
          href="/partnerships"
          className="inline-flex items-center gap-4 mb-10 group hover:opacity-80 transition-opacity"
        >
          <ArrowLeft className="w-8 h-8 text-[#FCFCFC]" strokeWidth={1.5} />
          <span className="text-2xl font-normal text-[#FCFCFC]">
            Back to Partnerships
          </span>
        </Link>

        {/* (Optional) show slug */}
        {/* <div className="mb-6 text-sm text-[#9E9E9E]">slug: {slug}</div> */}
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col md:flex-row-reverse md:items-center md:justify-between gap-6">
                ...
                <div className="flex justify-start md:justify-end">
                  <a
                    href="#"
                    className="flex items-center justify-center px-6 py-3 rounded-full bg-[#F29F04] hover:bg-[#e09204] transition-colors text-[#0D0D0D] font-medium text-base leading-[26px]"
                  >
                    Go to the website
                  </a>
                </div>
              ...
              <div className="flex flex-wrap items-start content-start gap-2.5">
                ...
                <div className="flex items-center gap-3 px-3 py-3 rounded-full border border-[#B3B3B3] bg-transparent">
                  ...
                  <span className="font-normal text-sm leading-4 text-[#B3B3B3]">
                    4.8
                  </span>
                </div>
              </div>
            ...
            <div className="flex flex-col gap-8">
              <div className="flex flex-col gap-8">
                ...
                <div className="text-xl font-normal leading-8 text-[#9E9E9E] tracking-[-0.64px] space-y-8">
                  <p>
                    CPAgetti is a multi-vertical affiliate program offering a wide
                    range of offers across Nutra (COD, SS, Trial) and
                    Gambling/Betting verticals. The platform provides access to
                    over 1,200 offers, allowing every webmaster to find a suitable
                    option for almost any traffic source.
                  </p>
                  <p>
                    Key advantages of CPAgetti: fast launch of required offers,
                    free landing page translations, access to free prelanders,
                    and much more! Partners can also take advantage of the
                    network’s Telegram bot, which regularly updates
                    top-performing offers. It also allows you to monitor your
                    personal account (statistics, payouts, flows, etc.) directly
                    via Telegram.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8">
                ...
                <div className="flex flex-wrap items-start gap-6">
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-xl font-normal leading-8 text-[#9E9E9E]">
                      Visa
                    </span>
                  </div>
              ...
              <div className="flex flex-col gap-8">
                ...
                <div className="flex flex-col gap-2">
                  <p className="text-xl font-normal leading-8 text-[#9E9E9E]">
                    Personal manager
                  </p>
                  <p className="text-xl font-normal leading-8 text-[#9E9E9E]">
                    Payouts on request
              ...
              <div className="flex items-center gap-6 mt-2">
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="text-base font-normal leading-4 text-[#EEEEEE]">
                    11 views
                  </span>
                </div>

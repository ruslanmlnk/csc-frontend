      ...
      <div className="relative z-20 flex flex-col items-center w-full max-w-[1280px] px-5 pt-[120px] md:pt-[162px]">
        ...
        <div className="flex flex-col items-center gap-10 md:gap-[56px] w-full text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-[16px] md:gap-[24px] w-full max-w-[380px]">
            <button className="flex items-center justify-center w-full sm:w-[180px] h-[50px] bg-[#F29F04] rounded-[80px] text-[#0D0D0D] font-medium text-[16px] leading-[26px] transition-all hover:brightness-110 active:scale-95 shadow-[0_0_20px_rgba(242,159,4,0.4)]">
              {data?.primaryButtonText || "Become a partner"}
            </button>

            <button className="flex items-center justify-center w-full sm:w-[180px] h-[50px] border border-[#FCC660] rounded-[80px] text-[#FCC660] font-medium text-[16px] leading-[26px] transition-all hover:bg-[#FCC660]/10 active:scale-95">

...
const AboutUs: React.FC = () => {
    return (
        <section className="relative w-full bg-[#0D0D0D] py-[120px] px-[20px] md:px-[100px] flex flex-col items-center overflow-hidden">
            <div className="relative z-10 w-full max-w-[1240px] flex flex-col lg:flex-row items-center gap-[64px] self-center">

                {/* --- Left Side: Picture/Graphic (592x680) --- */}
                <div className="relative w-full lg:w-[592px] h-[680px] bg-[#1A1A1A] rounded-[40px] border border-[rgba(74,74,74,0.70)] overflow-hidden backdrop-blur-[2px] flex-shrink-0 shadow-lg">
                    ...
                    <div className="absolute left-[101px] top-[50px] w-[390px] h-[630px] z-10">
                        <Image
                    ...
                    <div
                        className="absolute left-[245px] top-[227px] w-[327px] h-[92px] rounded-[12px] border border-white/30 backdrop-blur-[40px] px-[20px] py-[20px] flex items-center gap-[12px] z-20 shadow-2xl transition-transform hover:scale-105 duration-500"
                        style={{
                            background: 'radial-gradient(114.2% 133.85% at 7.14% 3.6%, rgba(35, 35, 54, 0.80) 0%, #232336 0.01%, rgba(35, 35, 54, 0.30) 100%)'
                        }}
                    >
                        <div className="w-[24px] h-[24px] flex-shrink-0 text-white">
                        ...
                        <div className="flex-1 flex justify-between items-start">
                            <div className="flex flex-col">
                                <span className="text-[#FCFCFC] font-poppins text-[16px] font-medium leading-[26px]">Converted ETH</span>
                                <span className="text-[#FDD892] font-poppins text-[16px] font-normal leading-[26px]">-0.7 ETH</span>
                            </div>
                            <div className="flex flex-col items-end">
                                <span className="text-[#FCFCFC] font-poppins text-[16px] font-medium leading-[26px]">+0.052 BTC</span>
                            </div>
                        </div>
                    </div>

                    {/* Floating Transaction Card: Solana */}
                    <div className="absolute left-[47px] top-[567px] w-[405px] h-[88px] bg-[#232336] rounded-[16px] px-[16px] py-[12px] flex items-center gap-[16px] z-20 shadow-2xl transition-transform hover:scale-105 duration-500">
                        ...
                        <div className="flex-1 flex justify-between items-center text-white">
                            <div className="flex flex-col">
                                <span className="font-poppins text-[20px] font-medium leading-[32px]">Solana</span>
                                <span className="text-[#BDBDBD] font-poppins text-[16px] font-normal leading-[26px]">34.5 SOL</span>
                            </div>
                            <div className="flex flex-col items-end">
                                <span className="font-poppins text-[20px] font-medium leading-[32px]">$1560.60</span>
                                <span className="text-[#20A12B] font-poppins text-[20px] font-normal leading-[32px]">+0.64%</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex-1 flex flex-col items-start gap-[56px]">
                    <div className="flex flex-col items-start gap-[24px] self-stretch">
                        ...
                        {/* Title with Gradient */}
                        <h2
                            className="self-stretch font-poppins text-[56px] font-medium leading-[72px] tracking-[-2.24px] bg-clip-text text-transparent"
                    ...
                    {/* Learn More Button */}
                    <button className="flex w-[180px] py-[12px] px-[24px] justify-center items-center gap-[12px] rounded-[80px] bg-[#F29F04] transition-all hover:brightness-110 active:scale-95">

...
const LatestPosts: React.FC = () => {
    ...
    return (
        <section className="w-full py-[120px] px-5 flex flex-col items-center gap-[64px] max-w-[1440px] mx-auto overflow-hidden">
            {/* Heading Section */}
            <div className="flex flex-col items-center gap-[32px] w-full max-w-[1240px]">
                ...
                {/* Categories Filter */}
                <div className="flex flex-wrap items-center justify-center gap-[8px] p-[8px] rounded-[80px] border-[0.5px] border-[rgba(74,74,74,0.70)] bg-[#1A1A1A] w-full">
                    {categories.map((cat) => (
                        <button
                            key={cat}
            ...
            {/* Posts Grid */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-[24px] w-full max-w-[1240px]">
                {posts.map((post, index) => (
                    <div key={index} className="flex flex-col items-start gap-[24px] p-[16px] pb-[32px] rounded-[40px] border border-[rgba(74,74,74,0.70)] bg-[#1A1A1A] group cursor-pointer transition-all duration-300 hover:border-[#FCC660]">
                        ...
                        <div className="flex flex-col items-start gap-[16px] w-full px-[16px]">
                            <div className="w-full text-right text-[#BDBDBD] font-poppins text-[16px] leading-[26px]">
                                {post.date}
                            </div>

                            <div className="flex flex-col items-start gap-[12px] w-full">
                                <div className="px-[12px] py-[5px] rounded-[80px] border-[0.5px] border-[#FCC660] text-[#FCC660] text-[14px] leading-[16px]">
                                    {post.category}
                                </div>
            ...
            {/* See More Button */}
            <button className="flex justify-center items-center px-[24px] py-[12px] gap-[16px] rounded-[80px] border border-[#FCC660] text-[#FCC660] font-poppins text-[16px] font-medium leading-[26px] transition-all hover:bg-[#FCC660]/10 active:scale-95">
                See More Posts
            </button>

            {/* Bottom Banner Image */}
            <div className="w-full max-w-[1240px] mt-[0px]">

        ...
        <div className="flex flex-col items-start gap-10 self-stretch pt-8 border-t border-[rgba(74,74,74,0.7)]">
          ...
          <div className="flex items-center gap-10 self-stretch">
            <div className="flex items-center gap-8">
              <button type="button" aria-label={saveAriaLabel} className="inline-flex h-6 w-6 items-center justify-center text-[#EEEEEE]">
              ...
              <button type="button" aria-label={shareAriaLabel} className="inline-flex h-6 w-6 items-center justify-center text-[#EEEEEE]">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                  <path

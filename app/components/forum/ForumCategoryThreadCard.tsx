...
const ForumCategoryThreadCard: React.FC<ForumCategoryThreadCardProps> = ({
    ...
    return (
        <div className="flex flex-col gap-6 p-6 rounded-[40px] border border-[rgba(74,74,74,0.70)] bg-[#1A1A1A] w-full">
            {/* Header: Icon, Category */}
            <div className="flex justify-between items-center self-stretch">
                <div className="flex items-center gap-4">
                    {/* Icon Box */}
                    <div className="flex w-16 h-16 p-4 items-center justify-center gap-2.5 rounded-[18px] bg-[#F29F04] shrink-0">
                    ...
                    <div className="flex items-start gap-6">
                        <div className="text-white font-poppins text-xl font-medium leading-[32px]">
                            {category}
                        </div>
                        <div className="flex items-center gap-2.5">
                            ...
                            <div className="text-[#F29F04] font-poppins text-xl font-medium leading-[32px]">
                                {replyCount}
                            </div>
                        </div>
                    </div>
            ...
            {/* Content Row */}
            <div className="flex pl-5 items-start gap-2.5 border-l border-white/20 relative">
                <div className="flex flex-col items-start gap-2.5 flex-1">
                    <div className="overflow-hidden text-[#FFF] text-ellipsis whitespace-nowrap font-poppins text-base font-normal leading-[32px] w-full max-w-[200px] lg:max-w-[400px]">
                        {title}
                    </div>
                    <div className="flex items-center gap-2.5">
                        <div className="text-[#6C6C6C] text-right font-poppins text-base font-normal leading-[16px]">
                            {date}
                        </div>
                    </div>
                </div>
                ...
                {/* Avatar */}
                <div className="relative w-[68px] h-[68px] rounded-full border border-white/50 overflow-hidden shrink-0 bg-[#333]">
                    <Image
                        src={authorAvatar}
                        alt="Author"
                        fill

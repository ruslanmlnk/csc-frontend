...
const ForumSidebar: React.FC = () => {
    return (
        <div className="flex flex-col gap-[24px] w-[397px] shrink-0">
            <div className="bg-[#1A1A1A] border border-[rgba(74,74,74,0.70)] rounded-[40px] p-[32px] flex flex-col gap-[24px]">
                <div className="flex items-center gap-[16px]">
                    ...
                    <span className="text-[20px] font-medium">Popular threads</span>
                </div>

                <div className="flex flex-col gap-[16px]">
                    {[1, 2, 3].map((item) => (
                        <div key={item} className="flex flex-col gap-[12px]">
                            <h4 className="text-[16px] font-medium leading-[32px] line-clamp-1">Can you recommend where to watch videos on learning TikTok UBT?</h4>
                            <div className="flex justify-end items-center gap-[10px] text-[#6C6C6C] text-[16px]">
            ...
            <div className="relative w-[397px] h-[631px] rounded-[20px] overflow-hidden">
                <Image
                    src="https://api.builder.io/api/v1/image/assets/TEMP/1df77007f20fb9ad313a0326ef07f148489cc4a4?width=794"
                    alt="Advertisement"
                    fill

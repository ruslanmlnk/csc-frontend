...
const ForumThreadCard: React.FC = () => {
    return (
        <div className="bg-[#1A1A1A] border border-[rgba(74,74,74,0.70)] rounded-[40px] p-[23.2px] flex flex-col gap-[24px]">
            <div className="flex justify-between items-center w-full">
                <div className="flex items-center gap-[16px]">
                    <div className="w-[64px] h-[64px] rounded-[18.286px] bg-[#F29F04] flex items-center justify-center p-[16px]">
                    ...
                    <div className="flex flex-col gap-[10px]">
                        ...
                        <span className="text-[#6C6C6C] text-[16px] font-normal leading-[16px]">We read, delve into, discuss</span>
                    </div>
                </div>

                <div className="flex flex-col gap-[10px] pl-[20px] border-l border-white/20 items-start">
                    <h4 className="text-[16px] font-normal leading-[32px] text-white line-clamp-1 w-[140px] text-ellipsis text-left">News and announcements</h4>

    ...
    return (
        <div className="flex flex-col gap-4 w-full">
            <div className="w-full flex flex-col gap-4 lg:hidden">
                <div className="h-[50px] min-w-0 flex items-center gap-4 rounded-[80px] border-[0.5px] border-[rgba(74,74,74,0.70)] bg-[#1A1A1A] pl-2 pr-4">
                    <div className="h-full w-full flex items-center gap-[10px] rounded-[80px] px-4">
            ...
            <div className="hidden lg:flex flex-row items-center justify-center p-2 gap-4 rounded-[80px] border-[0.5px] border-[rgba(74,74,74,0.7)] bg-[#1A1A1A] w-full">
                {categories.map((cat) => (
                    <button
                        key={cat}

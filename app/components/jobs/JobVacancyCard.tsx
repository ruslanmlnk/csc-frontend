...
export type JobVacancyBadge = 'top' | 'urgent' | 'none' | null | undefined
...
const JobVacancyCard: React.FC<JobVacancyCardProps> = ({
  dateLabel,
  title,
  location,
  workFormat,
  ...
  return (
    <div className="group flex flex-col justify-center items-start gap-[31px] rounded-[40px] border border-[rgba(74,74,74,0.70)] bg-[#1A1A1A] p-[32px] transition-all duration-300 hover:border-[#FCC660]">
      <div className="flex w-full flex-col gap-2">
        <div className="flex w-full items-center justify-between">
          <span className="font-poppins text-[14px] font-normal leading-[16px] text-[#BDBDBD]">{dateLabel}</span>
          {badgeVisuals ? (
            <div
              className="flex items-center rounded-[80px] border px-[12px] py-[6px] text-[14px] font-normal leading-[16px] text-white"
              style={{ backgroundColor: `${badgeVisuals.color}40`, borderColor: badgeVisuals.color }}
            >
              {badgeVisuals.label}
            </div>
          ) : null}
        ...
        <h3 className="line-clamp-2 h-[64px] overflow-hidden font-poppins text-[20px] font-medium leading-[32px] text-white">
          {title}
        </h3>
      </div>
      ...
      <div className="flex w-full flex-col gap-[10px]">
        <div className="flex h-8 items-center gap-[10px]">
          ...
          <span className="text-[14px] font-normal leading-[16px] text-[#B3B3B3]">{location}</span>
        </div>
        ...
        <div className="flex h-8 items-center gap-[10px]">
          ...
          <span className="text-[14px] font-normal leading-[16px] text-[#B3B3B3]">{workFormat}</span>
        </div>
        ...
        <div className="flex h-8 items-center gap-[10px]">
          ...
          <span className="text-[14px] font-normal leading-[16px] text-[#B3B3B3]">{experience}</span>
        </div>
      </div>

      <div className="flex w-full flex-col gap-[16px]">
        <div className="flex flex-col gap-[5px]">
          <span className="font-poppins text-[20px] font-semibold leading-[32px] text-white">{salary}</span>
          <span className="font-poppins text-[14px] font-normal leading-[16px] text-[#B3B3B3]">{salaryInfo}</span>
        </div>
      </div>

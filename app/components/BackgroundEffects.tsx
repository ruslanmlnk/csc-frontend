...
const BackgroundEffects: React.FC = () => {
  return (
    <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none select-none">
      ...
      <div className="absolute top-[-50%] left-1/2 transform -translate-x-1/2 w-[150%] h-[150%] rounded-full bg-radial-gradient from-transparent via-[#0D0D0D]/50 to-[#0D0D0D] pointer-events-none"></div>
    </div>
  );
};
